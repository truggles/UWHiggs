...
class ZHAnalyzerBase(MegaBase):
    ...
    def begin(self): 
        ...
        for folders, regionInfo in self.build_zh_folder_structure().iteritems():
            ...
            self.book(folder, "Event_ID", "Event ID", 'run:lumi:evt1:evt2:zmass:hmass:eVetoZH:muVetoZH:tauVetoZH:t1JetPt:t2JetPt', type=ROOT.TNtuple)
