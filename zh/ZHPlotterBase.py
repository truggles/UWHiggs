    ...
    def write_shapes(self, variable, rebin, outdir, unblinded=True):
        ...
        if variable == "A_SVfitMass":
            ...
            for mass in [220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320, 330, 340, 350]:
                ...
                signal.Write()
        # Commented out for ULBs prefered naming style, i'm keeping ours cuz UW rocks.
        #if variable == "A_SVfitMass":
        #    obs.SetName('data_obs')
        #    Zjets.SetName('Zjets')
        ...
        #        signal.Write()
            ...
            TTZJets.SetName('TTZJets_'+variable)
            VHWW.SetName('VHWW_'+variable)
            ...
            for mass in [220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320, 330, 340, 350]:
                signal = sig_view['AZhtt%i' % mass].Get(variable)
                signal.SetName('AHttZll%i_%s' % (mass, variable) )
                signal.Write()
