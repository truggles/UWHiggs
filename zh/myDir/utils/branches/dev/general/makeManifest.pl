...
my $VERSION = sprintf "%d.%03d", q$Revision: 272770 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 272770 $
   # \RCS$Date: 2014-12-30 09:15:27 -0600 (Tue, 30 Dec 2014) $
   # \RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/utils/branches/dev/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 272770 2014-12-30 15:15:27Z alverson $
