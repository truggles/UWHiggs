...
my $VERSION = sprintf "%d.%03d", q$Revision: 43188 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 43188 $
   # \RCS$Date: 2011-03-02 08:10:56 -0600 (Wed, 02 Mar 2011) $
   # \RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/utils/tags/v1/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 43188 2011-03-02 14:10:56Z alverson $
